...
const AdvancedSearch = ({ isOpen, onClose, onSearch }) => {
  ...
  return (
    <div className="fixed inset-0 bg-black/50 backdrop-blur-sm flex items-center justify-center z-50 p-4">
      <div className="bg-gradient-to-br from-black/90 via-gray-900/90 to-black/90 backdrop-blur-2xl rounded-2xl shadow-2xl w-full max-w-2xl max-h-[90vh] overflow-y-auto border border-white/10">
        ...
        <div className="p-6 space-y-6">
          <div>
            ...
            <input
              ...
              className="w-full px-4 py-3 bg-white/10 border border-white/20 rounded-xl text-white placeholder-gray-400 focus:ring-2 focus:ring-blue-500 focus:border-blue-500 backdrop-blur-sm"
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
            <div>
              ...
              <select
                ...
                className="w-full px-4 py-3 bg-white/10 border border-white/20 rounded-xl text-white focus:ring-2 focus:ring-blue-500 focus:border-blue-500 backdrop-blur-sm"
              >
          ...
          <div>
            <label className="block text-sm font-medium text-gray-300 mb-2">Minimum Replies</label>
            <input
              type="number"
          ...
          <div>
            <label className="flex items-center space-x-2">
              ...
              />
              <span className="text-sm font-medium text-gray-300">Has Images</span>
            </label>
          </div>
