        ...
        <div className="bg-white rounded-xl p-6 shadow-sm border">
          <div className="flex items-center justify-between">
            <div>
              ...
              <p className="text-3xl font-bold text-gray-900">{stats.totalReplies}</p>
            </div>
      ...
      <div className="grid grid-cols-1 lg:grid-cols-2 gap-6">
            ...
            {recentThreads.map((thread) => (
              <div key={thread._id} className="flex items-center space-x-3">
                ...
                <div className="flex-1">
                  ...
                  <p className="text-xs text-gray-500">by {thread.author?.username} • {new Date(thread.createdAt).toLocaleDateString()}</p>
                </div>
              </div>
            ))}
          </div>
        ...
        <div className="bg-white rounded-xl p-6 shadow-sm border">
          ...
          <div className="grid grid-cols-2 gap-4">
            <Link to="/admin/users" className="p-4 border-2 border-dashed border-gray-200 rounded-lg hover:border-blue-300 hover:bg-blue-50 transition-colors block">
              <div className="text-center">
                <span className="text-2xl block mb-2">👥</span>
                <span className="text-sm font-medium text-gray-700">Manage Users</span>
              </div>
            </Link>
            <Link to="/admin/categories" className="p-4 border-2 border-dashed border-gray-200 rounded-lg hover:border-blue-300 hover:bg-blue-50 transition-colors block">
              <div className="text-center">
                <span className="text-2xl block mb-2">📁</span>
                <span className="text-sm font-medium text-gray-700">Categories</span>
              </div>
            </Link>
            <Link to="/admin/threads" className="p-4 border-2 border-dashed border-gray-200 rounded-lg hover:border-blue-300 hover:bg-blue-50 transition-colors block">
              <div className="text-center">
                <span className="text-2xl block mb-2">💬</span>
